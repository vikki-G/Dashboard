...
function loadChannelDetails(_list) {
	...
	result[result.length - 4] = calculateServiceLevelPercentage(totalList[0]);
	result[result.length - 09] = (totalList[0].maxWaitTime);
	result[result.length - 10] = calculateAverageQueueTime(totalList[0]);
	result[result.length - 11] = calculateAverageHandleTime(totalList[0]);
	result[result.length - 12] = calculateAverageWrapTime(totalList[0]);
	result[result.length - 13] = calculateAverageHoldTime(totalList[0]);
	result[result.length - 14] = calculateAverageTalkTime(totalList[0]);
	//result[result.length - 17] = calculateDeferredPercentage(totalList[0]);
...
function loadLanguageDetails(_list) {
	...
	result1[result1.length - 1] = calculateExpectedWaitTime(totalList[0]);
	result1[result1.length - 4] = calculateServiceLevelPercentage(totalList[0]);
	result1[result1.length - 9] = (totalList[0].maxWaitTime);
	result1[result1.length - 10] = calculateAverageQueueTime(totalList[0]);
	result1[result1.length - 11] = calculateAverageHandleTime(totalList[0]);
	result1[result1.length - 12] = calculateAverageWrapTime(totalList[0]);
	result1[result1.length - 13] = calculateAverageHoldTime(totalList[0]);
	result1[result1.length - 14] = calculateAverageTalkTime(totalList[0]);
	//result1[result1.length - 20] = calculateDeferredPercentage(totalList[0]);
...
function loadLocationDetails(_list) {
	...
	result2[result2.length - 1] = calculateExpectedWaitTime(totalList[0]);
	result2[result2.length - 4] = calculateServiceLevelPercentage(totalList[0]);
	result2[result2.length - 9] = (totalList[0].maxWaitTime);
	result2[result2.length - 10] = calculateAverageQueueTime(totalList[0]);
	result2[result2.length - 11] = calculateAverageHandleTime(totalList[0]);
	result2[result2.length - 12] = calculateAverageWrapTime(totalList[0]);
	result2[result2.length - 13] = calculateAverageHoldTime(totalList[0]);
	result2[result2.length - 14] = calculateAverageTalkTime(totalList[0]);
...
function loadDepartmentDetails(_list) {
	...
	$("#tbl_perfdepartment > tbody").html("");
		...
		for (var i = 0; i < queueList.length; i++) {
			...
			html_Depart += "<td class=\"perentCell align-center\" data-label=\"Consult Initiated\">" + cleanHTML(queueList[i].consultInitiatedToService) + "</td>";
			html_Depart += "<td class=\"perentCell align-center\" data-label=\"Consult Accepted\">" + cleanHTML(queueList[i].consultAcceptedFromService) + "</td>";
		...
		result3[result3.length - 1] = calculateExpectedWaitTime(totalList[0]);
		result3[result3.length - 4] = calculateServiceLevelPercentage(totalList[0]);
		result3[result3.length - 9] = (totalList[0].maxWaitTime);
		result3[result3.length - 10] = calculateAverageQueueTime(totalList[0]);
		result3[result3.length - 11] = calculateAverageHandleTime(totalList[0]);
		result3[result3.length - 12] = calculateAverageWrapTime(totalList[0]);
		result3[result3.length - 13] = calculateAverageHoldTime(totalList[0]);
		result3[result3.length - 14] = calculateAverageTalkTime(totalList[0]);
...
function bindChannelDropDownValues(_details){
    ...
    if (_details != undefined) {
        for (var i = 0; i < _details.length; i++) {
			var _appendText = ("<option value='" + cleanHTML(_details[i].channel) + "'>" + cleanHTML(_details[i].channel) + "</option>");
